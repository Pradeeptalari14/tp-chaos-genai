...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/chaos-genai/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-chaos-genai.git
cd tp-chaos-genai
```
...
```bash
kubectl port-forward deployment/tp-chaos-genai 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── chaos_mesh.yaml     # Main configuration file
```
...
---
*Generated by [Chaos Engineering for GenAI Studio](https://pradeeptalari14.github.io/portfolio/tools/chaos-genai/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
